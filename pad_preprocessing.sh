...
# Adds a white border around the image, keeping the original cropping
...
for file in **/*; do
    ...
    # CASE 2: IMAGES
        ...
        # Rotate 90 degrees, resize, and pad with white background
        convert "$file" -auto-orient -rotate 90 -resize 1920x1080 -background white -gravity center -extent 1920x1080 "${file%.*}_processed.jpg"
